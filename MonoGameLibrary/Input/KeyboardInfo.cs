...
public class KeyboardInfo
{
	...
	/// Each time Update is called, the current state becomes the previous state, and we get a fresh current state. 
	/// This creates our frame-to-frame comparison chain.
    /// </summary>
    public void Update()
    {
